...
import james_bill_data from "../../../../jamesBill.json";
...
const attendees = james_bill_data.filter((attendee) => attendee.estimatedArr);
...
export default function Component() {
  ...
  const [visibleAttendees, setVisibleAttendees] = useState(
    attendees.slice(0, 8)
  ); // Assuming 8 attendees per page
      ...
      <div className="w-full h-full mx-auto bg-white">
        <div className="p-6">
          <h2 className="text-3xl font-light mb-4">
            Attendees that match your goal and target audience
          </h2>
            ...
            {visibleAttendees.map(
              (attendee, index) => (
                ...
                (
                  ...
                  >
                    <div
                      dangerouslySetInnerHTML={{ __html: attendee.description }}
                    />

                    {/* {attendee.opportunity && (
                      <p className="text-gray-700 mb-2 px-6">
                        {attendee.opportunity}
                      </p>
                    )} */}
